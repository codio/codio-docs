...
When actioned by the student, the comment will be marked as resolved but will still be available for review in the **Education -> Code Comments** menu item.  Students can also go to this to see all comments and click to open the neccessary file.
