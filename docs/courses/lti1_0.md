...
It is important to understand how Codio maps Canvas users to Codio users. The following rules should be understood. If students or faculty access Codio via a Canvas assignment then Codio will use the Canvas userID to identify the user. This allows users to change the email address in Canvas without additional Codio accounts being created.
...
### Single sign-in and account creation
It is important to understand how Codio maps Blackboard users to Codio users. The following rules should be understood. If students or faculty access Codio via a Blackboard assignment then Codio will use the Blackboard userID to identify the user. This allows users to change the email address in Blackboard without additional Codio accounts being created.
...
If a Moodle user already has a Codio account then provided the userID of their Moodle account is the same, the same Codio account will be used. This allows users to change the email address in Moodle without additional Codio accounts being created.
